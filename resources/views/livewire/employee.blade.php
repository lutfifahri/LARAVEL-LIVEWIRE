<div class="container">
    ...
    <div class="my-3 p-3 bg-body rounded shadow-sm">
        ...
        @if ($employe_selected_id)
            <a wire:click="delete_confirmation('')"class="btn btn-danger btn-sm mb-3" data-bs-toggle="modal" data-bs-target="#exampleModal">Del Jumlah Data {{count($employe_selected_id)  }}</a>
        @endif
        ...
        <table class="table table-striped">
            ...
            <tbody>
                @foreach ($dataEmployees as $key => $value)
                    <tr>
                        <td><input type="checkbox" wire:key="{{ $value->id }}" value="{{ $value->id }}" wire:model.live="employe_selected_id"></td>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h1 class="modal-title fs-5" id="exampleModalLabel">Confirmasi Delete</h1>
