...
class Employee extends Component
{
    ...
    public function delete()
    {
        ...
        if (count($this->employe_selected_id)) {
            for ($x=0; $x<count($this->employe_selected_id) ; $x++) { 
                ModelsEmployee::find($this->employe_selected_id[$x])->delete();
            }
        }
